                  ...
                  <div class="box-cmt__box-question">
                    ...
                    <div class="content">
                      <div>
                        ...
                        <a
                          href="https://cellphones.com.vn/thu-cu-doi-moi"
                          target="_blank"
                          rel="noopener nofollow"
                          >https://cellphones.com.vn/thu-cu-doi-moi</a
                        >
                      </div>
                    </div>
                    <div class="content">
...
.block-comment__box-list-comment
  .list-comment
  .item-comment__box-cmt
  .box-cmt__box-question:has(.fieldset-bottom) {
...
.block-comment__box-list-comment
  .list-comment
  .item-comment__box-cmt
  .box-cmt__box-question.show-all-reply {
  border-left: 1.5px solid #e4e4e7;
}
...
@media screen and (max-width: 540px) {
  ...
  .block-comment__box-list-comment
    .list-comment
    .item-comment__box-cmt:last-of-type {
    border-bottom: none;
  }
