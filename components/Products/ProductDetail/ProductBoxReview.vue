    ...
    <div class="boxReview-review" bis_skin_checked="1">
      <div class="boxReview-overview" bis_skin_checked="1">
        <div class="boxReview-score has-product" bis_skin_checked="1">
          ...
          <p class="boxReview-score__count">56 lượt đánh giá</p>
        </div>
        <button type="button" class="button button__review">
          Viết đánh giá
        </button>
      </div>
      <div class="boxReview-star has-product" bis_skin_checked="1">
        ...
        >
          ...
          <progress max="56" class="progress is-small m-0" value="5"></progress>
        ...
        >
          ...
          <progress max="56" class="progress is-small m-0" value="0"></progress>
        ...
        <div class="boxReview-comment-item" bis_skin_checked="1">
          ...
          <div class="boxReview-comment-item-review" bis_skin_checked="1">
            ...
            <div class="date-time" bis_skin_checked="1">
              ...
              Đánh giá đã đăng vào 3 tuần trước
            </div>
          </div>
        </div>
        <div class="boxReview-comment-item" bis_skin_checked="1">
...
.boxReview-overview .boxReview-score {
  align-items: center;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
.boxReview-overview .boxReview-score .rating {
  align-items: center;
  color: #a1a1aa;
  display: flex;
  font-size: 32px;
...
.boxReview-overview .boxReview-score .rating .average-rating {
  color: #18181b;
  font-size: 48px;
  font-weight: 700;
}

.boxReview-overview .boxReview-score .item-star {
  height: 24px;
  margin-right: 0;
  width: 130px;
}

.boxReview-overview .boxReview-score .item-star .star-container,
.boxReview-overview .boxReview-score .item-star .star-container-level {
  height: fit-content;
}

.boxReview-overview .boxReview-score .item-star .star-container .icon {
  fill: rgba(145, 158, 171, 0.522);
  height: 24px;
  width: 24px;
}

.boxReview-overview .boxReview-score .item-star .star-container-level .icon {
  fill: #ffbf00;
  stroke: #ffbf00;
  height: 24px;
  margin-right: 2px;
...
.boxReview-overview .boxReview-score .boxReview-score__count {
  cursor: pointer;
}
...
.boxReview-star div .is-active {
  fill: #ffbf00;
  margin-left: 2px;
  width: 13px;
}

.boxReview-star div span {
  color: #a1a1aa;
  font-size: 12px;
  width: 75px;
}
...
.boxReview-star progress::-webkit-progress-value,
.boxReview-star progress::-moz-progress-bar {
  background-color: #d70018;
}

.boxReview-star progress::-ms-fill {
  background-color: #d70018;
  border: none;
}
...
.box-experience-review .experience-review__item {
  align-items: center;
  display: flex;
  font-size: 16px;
...
.box-experience-review .experience-review__item .item-title {
  width: 170px;
}

.box-experience-review .experience-review__item .item-review-result {
  font-size: 14px;
  margin-bottom: 5px;
}
...
#review .box-review-filter .title {
  font-size: 20px;
  margin: 0;
}

#review .box-review-filter .filter-container {
  display: flex;
  gap: 8px;
  overflow: auto;
}

#review .box-review-filter .filter-container .filter-item {
  align-items: center;
...
#review .box-review-filter .filter-container .filter-item.active {
  background-color: #eff5ff;
  border-color: #3b82f6;
  color: #2570eb;
}

#review .boxReview-comment {
  margin: 30px 0 15px;
  width: 100%;
}

#review .boxReview-comment .load-more {
...
#review .boxReview-no-comment .button__review {
  background: #d70018;
  border-radius: 8px;
  color: #fff;
  cursor: pointer;
...
#review .boxReview-comment .boxReview-comment-item-title div p.name-letter {
...
#review .boxReview-comment .boxReview-comment-item-title div span.name {
...
#review .boxReview-comment .boxReview-comment-item-review {
  display: flex;
  flex-direction: column;
  gap: 8px;
  width: 100%;
...
#review .boxReview-comment .boxReview-comment-item-review .item-review-rating {
  align-items: center;
  flex-wrap: wrap;
  font-size: 12px;
  gap: 10px;
...
#review .boxReview-comment .boxReview-comment-item-review .bought-cps {
  color: #229a16;
  font-size: 14px;
  gap: 3px;
}
...
#review .boxReview-comment .boxReview-comment-item-review .item-review-comment {
  font-size: 14px;
}
...
#review .boxReview-comment .boxReview-comment-item-review .date-time {
  align-items: center;
  color: #a1a1aa;
  display: flex;
  font-size: 14px;
...
#review .boxReview-comment .boxReview-comment-item {
...
#review .boxReview-comment .boxReview-comment-item:last-of-type {
  border-bottom: none;
}
...
.item-star .star-container .icon {
  margin-right: 2px;
}

.item-star .star-container-level {
  display: flex;
  height: 100%;
  left: 0;
  overflow: hidden;
...
.item-star .star-container-level .icon {
  fill: #ffbf00;
  margin-right: 2px;
  stroke: #ffbf00;
}
...
.modal-review .modal-content .review-container {
  border-radius: 8px;
  height: 100%;
  overflow: auto;
  width: 100%;
...
.modal-review .modal-content .review-container .content__close-btn {
...
.modal-review .modal-content .review-container .content__close-btn-desk {
  cursor: pointer;
  position: fixed;
  right: 15px;
  top: 15px;
...
.modal-review .modal-content .review-container .title {
...
.modal-review .modal-content .review-container .modal-review-content {
  background-color: #fff;
  width: 100%;
}
...
.modal-review
  ...
  .group-input
  .btn-add {
  border: 1px dashed rgba(145, 158, 171, 0.239);
  border-radius: 8px;
  color: #637381;
  cursor: pointer;
  font-size: 13px;
...
.modal-review .modal-content .review-container .modal-review-content textarea {
  border-radius: 8px;
  margin: 10px 0;
  max-height: 40vh;
}
...
.modal-review
  ...
  bottom: 0;
  box-shadow: 0 -4px 20px -1px rgba(40, 124, 234, 0.149);
  left: 50%;
  padding-bottom: 10px;
  position: fixed;
  text-align: center;
...
@media only screen and (max-width: 540px) {
  ...
  .boxReview-review .boxReview-overview {
    flex-direction: row;
    justify-content: space-between;
    width: 100%;
  }
