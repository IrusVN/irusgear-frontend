<template>
    <div class="box-detail-product__box-left column">
        <div class="box-header box-header-desktop">
            <div class="box-product-name">
                <h1> iPhone 14 128GB | Chính hãng VN/A </h1>
            </div>
            <div class="is-flex is-align-items-center mt-2">
                <div class="box-rating"><svg height="15" viewBox="0 0 576 512">
                        <path
                            d="M381.2 150.3L524.9 171.5C536.8 173.2 546.8 181.6 550.6 193.1C554.4 204.7 551.3 217.3 542.7 225.9L438.5 328.1L463.1 474.7C465.1 486.7 460.2 498.9 450.2 506C440.3 513.1 427.2 514 416.5 508.3L288.1 439.8L159.8 508.3C149 514 135.9 513.1 126 506C116.1 498.9 111.1 486.7 113.2 474.7L137.8 328.1L33.58 225.9C24.97 217.3 21.91 204.7 25.69 193.1C29.46 181.6 39.43 173.2 51.42 171.5L195 150.3L259.4 17.97C264.7 6.954 275.9-.0391 288.1-.0391C300.4-.0391 311.6 6.954 316.9 17.97L381.2 150.3z">
                        </path>
                    </svg> <span>4.9</span> <span class="total-rating">(56 đánh giá)</span></div>
            </div>
            <div class="box-header__bottom">
                <div class="box-bottom-item"><button id="wishListBtn">
                        <div class="btn__effect button__add-wishlist inactive"><svg viewBox="20 18 29 28"
                                aria-hidden="true" focusable="false" class="heart-border icon-svg icon-svg--color-cps">
                                <path
                            ...
                            </svg> <span class="effect-group"><span class="effect"></span> <span class="effect"></span>
                                <span class="effect"></span> <span class="effect"></span> <span
                                    class="effect"></span></span></div> <span class="text-wishlist"
                            style="display:none;">&nbsp;Yêu thích</span>
                    </button> <span class="label">Yêu thích</span></div>
                <div class="box-bottom-item"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 9H16" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M8 13H14" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path
                    ...
                    </svg> <span class="label">Hỏi đáp</span></div>
                <div class="box-bottom-item"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect x="5" y="5" width="14" height="14" rx="2" stroke="#3B82F6" stroke-width="1.5"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M3 10H5" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M3 14H5" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M10 3V5" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M14 3V5" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M21 10H19" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M21 14H19" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M14 21V19" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M10 21V19" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                    </svg> <span class="label"> Thông số </span></div>
                <div class="pdp-compare-button-box is-flex is-align-items-center"><svg width="24" height="24"
                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 9.61305 20.0518 7.32387 18.364 5.63604C16.6761 3.94821 14.3869 3 12 3C9.61305 3 7.32387 3.94821 5.63604 5.63604C3.94821 7.32387 3 9.61305 3 12Z"
                            stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M9 12H15" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M12 9V15" stroke="#3B82F6" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                    </svg> <a class="label"> So sánh</a></div>
            </div>
        </div>
        <div class="box-gallery">
            <div class="gallery-product-detail mb-2">
                <div
                    class="gallery-slide gallery-top swiper-container swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                        <div class="swiper-slide ksp-gallery swiper-slide-active"
                            style="width: 589px; margin-right: 20px;">
                            <div class="box-ksp ksp-video">
                                <div class="video-thumbnail-wrapper"><img
                                        src="https://img.youtube.com/vi/8LwmuPL-YZU/maxresdefault.jpg"
                                        alt="Video thumbnail" class="video-thumbnail">
                                    <div class="youtube-play-button"><svg width="68" height="48" viewBox="0 0 68 48">
                                            <path
                        ...
                        <div id="v2Gallery" class="swiper-slide ksp-gallery swiper-slide-next"
                            style="width: 589px; margin-right: 20px;">
                            <div class="box-ksp is-flex is-flex-direction-row"><img
                                    ...
                                    width="358" height="358" alt="iPhone 14 128GB  | Chính hãng VN/A" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" class="mb-1 mr-2">
                                <div>
                                    <p class="title desktop">Tính năng nổi bật</p>
                                    <div class="desktop">
                                        <ul>
                                            <li>iPhone 14 trang bị màn hình Super Retina XDR 6,1 inch cho trải nghiệm
                                                hình ảnh sắc nét và sống động.</li>
                                            <li>Thời lượng pin cả ngày cho phép bạn xem video lên đến 20 giờ, luôn sẵn
                                                sàng cho những ngày làm việc dài.</li>
                                            <li>Với các tính năng độ bền như Ceramic Shield và khả năng chống nước,
                                                iPhone 14 đảm bảo an toàn trong mọi tình huống.</li>
                                            <li>Chip A15 Bionic với GPU 5 lõi mang lại hiệu suất siêu nhanh, cùng mạng
                                                di động 5G cho khả năng làm việc từ xa và họp trực tuyến chất lượng cao.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 1" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 2" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 3" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 4" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 5" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 6" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 7" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 8" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 9" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                        <div class="swiper-slide" style="width: 589px; margin-right: 20px;"><a
                                ...
                                class="spotlight"><img
                                    ...
                                    height="358" alt="iPhone 14 128GB  | Chính hãng VN/A - 10" loading="lazy"
                                    title="iPhone 14 128GB  | Chính hãng VN/A" rel="preload"></a></div>
                    </div>
                    <div class="swiper-button-next button__view-gallery-next" tabindex="0" role="button"
                ...
                <div
                    class="thumbnail-slide swiper-container gallery-thumbs swiper-container-initialized swiper-container-horizontal swiper-container-free-mode swiper-container-thumbs">
                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                        <div class="swiper-slide ksp-thumbs button__view-gallery-vid swiper-slide-visible swiper-slide-active swiper-slide-thumb-active"
                            style="margin-right: 10px;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="swiper-slide ksp-thumbs button__view-gallery-thumb swiper-slide-visible swiper-slide-next"
                            style="margin-right: 10px;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="swiper-slide button__view-gallery swiper-slide-visible" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone-14_2_1.jpg"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 1" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A"></div>
                        <div class="swiper-slide button__view-gallery swiper-slide-visible" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-1b_blue_color_vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 2" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A"></div>
                        <div class="swiper-slide button__view-gallery swiper-slide-visible" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-2_design_vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 3" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A"></div>
                        <div class="swiper-slide button__view-gallery swiper-slide-visible" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-3_camera_vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 4" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A"></div>
                        <div class="swiper-slide button__view-gallery swiper-slide-visible" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-4_lineup_vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 5" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A"></div>
                        <div class="swiper-slide button__view-gallery swiper-slide-visible" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-5_colors__vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 6" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A"></div>
                        <div class="swiper-slide button__view-gallery" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-6_size_comparison__vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 7" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A">
                        </div>
                        <div class="swiper-slide button__view-gallery" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-7_features_specs__vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 8" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A">
                        </div>
                        <div class="swiper-slide button__view-gallery" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-8_accessory_vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 9" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A">
                        </div>
                        <div class="swiper-slide button__view-gallery" style="margin-right: 10px;">
                            <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:58:58/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone_14_blue_pdp_image_position-9_typec_lightning_cable_vn.png"
                                width="58" height="58" alt="iPhone 14 128GB  | Chính hãng VN/A - 10" loading="lazy"
                                title="iPhone 14 128GB  | Chính hãng VN/A">
                        </div>
                    </div>
                    ...
                    <div class="swiper-button-prev button-navigate-thumbnail__prev swiper-button-disabled" tabindex="0"
                        role="button" aria-label="Previous slide" aria-disabled="false">
                        <div class="icon"><svg height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <path
                                    d="M224 480c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25l192-192c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l169.4 169.4c12.5 12.5 12.5 32.75 0 45.25C240.4 476.9 232.2 480 224 480z">
                                </path>
        ...
        <div class="mt-5">
            <div class="box-warranty-info">
                ...
                <div class="box-content warranty-info">
                    <div
                        class="swiper-container swiper-pdp swiper-container-initialized swiper-container-horizontal swiper-container-multirow">
                        <div class="swiper-wrapper" style="width: 602px; transform: translate3d(0px, 0px, 0px);">
                            <div class="swiper-slide swiper-slide-active"
                                style="order: 0; width: 291px; height: 148px; margin-right: 10px;">
                                <div class="item-warranty-info">
                                    <div class="icon"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_2841_934)">
                                                <path
                                                    ...
                                                    stroke="url(#paint0_linear_2841_934)" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                            </g>
                                            <defs>
                                                <linearGradient id="paint0_linear_2841_934" x1="10.125" y1="2.25"
                                                    x2="10.125" y2="15.75" gradientUnits="userSpaceOnUse">
                                    ...
                                    <div class="box-wrapper">
                                        <div class="description">Máy mới 100% , chính hãng Apple
                                            Việt Nam.<br>CellphoneS hiện là đại lý bán lẻ uỷ quyền iPhone chính hãng
                                            VN/A của Apple Việt Nam</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide swiper-slide-next"
                                style="-webkit-box-ordinal-group: 1; order: 1; width: 291px; height: 148px; margin-right: 10px;">
                                <div class="item-warranty-info">
                                    <div class="icon"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_2841_940)">
                                                <path
                                                    ...
                                                    stroke="url(#paint0_linear_2841_940)" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                            </g>
                                            <defs>
                                                <linearGradient id="paint0_linear_2841_940" x1="9.00491" y1="2.25"
                                                    x2="9.00491" y2="15.75" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#FFF5F0"></stop>
                                                    <stop offset="0.67" stop-color="#F4C8D0"></stop>
                                                </linearGradient>
                                    ...
                                    <div class="box-wrapper">
                                        <div class="description">1 ĐỔI 1 trong 30 ngày nếu có lỗi
                                            phần cứng nhà sản xuất. Bảo hành 12 tháng tại trung tâm bảo hành chính hãng
                                            Apple: CareS.vn<a href="https://cellphones.com.vn/chinh-sach-bao-hanh"
                                                target="_blank"> Xem chi tiết</a></div>
                                        <div class="description">
                                            Xem thông tin kích hoạt bảo hành các sản phẩm Apple
                                            <a target="_blank"
                                                href="https://cellphones.com.vn/kich-hoat-bao-hanh-sam-pham-apple">Chi
                                                tiết tại đây
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-slide"
                                style="-webkit-box-ordinal-group: 2; order: 2; margin-top: 10px; width: 291px; height: 148px; margin-right: 10px;">
                                <div class="item-warranty-info">
                                    <div class="icon"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                stroke="url(#paint0_linear_2841_949)" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <defs>
                                                <linearGradient id="paint0_linear_2841_949" x1="9" y1="2.25" x2="9"
                                    ...
                                    <div class="description">Hộp, Sách hướng dẫn, Cây lấy sim, Cáp
                                        Lightning - Type C</div>
                                </div>
                            </div>
                            <div class="swiper-slide"
                                style="-webkit-box-ordinal-group: 3; order: 3; margin-top: 10px; width: 291px; height: 148px; margin-right: 10px;">
                                <div class="item-warranty-info">
                                    <div class="icon"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_2841_954)">
                                                <path
                                                    ...
                                                    stroke="url(#paint0_linear_2841_954)" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                            </g>
                                            <defs>
                                                <linearGradient id="paint0_linear_2841_954" x1="9.00131" y1="4.5"
                                                    x2="9.00131" y2="15.0013" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#FFF5F0"></stop>
                                                    <stop offset="0.67" stop-color="#F4C8D0"></stop>
                                                </linearGradient>
                                    ...
                                    <div class="description">
                                        ...
                                        <a href="https://cellphones.com.vn/vat-refund" target="_blank">hoàn thuế VAT -
                                            Tax Refund</a>
                                        cho khách du lịch.
                                    </div>
                                </div>
                        ...
                        <div class="swiper-button-prev swiper-button-disabled swiper-button-lock" tabindex="0"
                            role="button" aria-label="Previous slide" aria-disabled="false">
                            <div><svg height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                    <path
                                        d="M224 480c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25l192-192c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l169.4 169.4c12.5 12.5 12.5 32.75 0 45.25C240.4 476.9 232.2 480 224 480z">
                                    </path>
                                </svg></div>
                        </div>
                        <div class="swiper-button-next swiper-button-disabled swiper-button-lock" tabindex="0"
                    ...
                    <div
                        class="swiper-container is-hidden swiper-container-initialized swiper-container-horizontal swiper-container-multirow">
                        <div class="swiper-wrapper" style="transition-duration: 0ms;">
                            <div class="swiper-slide" style="height: 148px;"></div>
                        </div>
                        <div class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets"></div><span
        ...
        <div id="thong-so-ky-thuat" promotion-pack="[object Object]" show-button-print="true"
            ...
            <div class="box-title is-flex is-justify-content-space-between is-align-items-center">
                <h2 class="title">Thông số kỹ thuật</h2> <button
                    class="button button__show-modal-technical is-flex is-justify-content-center">
                    Xem tất cả
                    <div class="icon-svg"><svg height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                            <path
                                d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z">
                            </path>
                        </svg></div>
            ...
            <table class="technical-content">
                <tbody>
                    ...
                    <tr class="technical-content-item">
                        ...
                        <td>
                            <p><a href="https://cellphones.com.vn/sforum/man-hinh-oled" target="_blank"
                                    rel="nofollow">OLED</a></p>
                        </td>
                    </tr>
                    <tr class="technical-content-item">
                        <td>Camera sau</td>
                        <td>
                            <p>Camera góc rộng: 12MP, ƒ/1.5<br>Camera góc siêu rộng: 12MP, ƒ/2.4</p>
                        </td>
                    </tr>
                    <tr class="technical-content-item">
                        <td>Camera trước</td>
                    ...
                    <tr class="technical-content-item">
                        ...
                        <td>
                            <p>Tần số quét 60Hz, 1200 nits, Kính cường lực Ceramic Shield, Super Retina XDR</p>
                        </td>
                    </tr>
                    <tr class="technical-content-item">
                        <td>Loại CPU</td>
        ...
        <div id="boxFAQ">
            ...
            <div role="tablist" class="accordion">
                <div class="accordion-item">
                    <div class="accordion-label button__show-faq">
                        <h3>Pin iPhone 14 có dung lượng bao nhiêu, dùng được trong bao lâu? Có hỗ trợ sạc nhanh không?
                        </h3>
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="10"
                                height="10">
                                <path
                    ...
                    <div class="accordion-content" style="max-height: 0px;">
                        <p>
                        <div>iPhone 14 có dung lượng 3.279 mAh với thời gian phát video tối đa 20
                            giờ, đồng thời tích hợp công suất sạc nhanh 20W trở lên hỗ trợ rút ngắn thời gian sạc pin
                            xuống còn 1 tiếng rưỡi.</div>
                        </p>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content" style="max-height: 0px;">
                        <p>
                        <div>iPhone 14 có 2 loại SIM cho người dùng lựa chọn bao gồm: SIM kép (1
                            SIM vật lý và 1 eSIM) và eSIM. Tuy nhiên, chỉ có mẫu máy iPhone 14 tại Mỹ sẽ bị loại bỏ khe
                            cắm SIM vật lý và chỉ sử dụng eSIM. Do đó iPhone 14 chính hãng tại Việt Nam vẫn còn khay sim
                            vật lý và hỗ trợ eSIM.</div>
                        </p>
                    </div>
                </div>
                <div class="accordion-item">
                    <div class="accordion-label button__show-faq">
                        <h3>Camera của iPhone 14 có cải tiến nổi bật nào so với iPhone 13?</h3>
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="10"
                                height="10">
                                <path
                                    d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z">
                    ...
                    <div class="accordion-content" style="max-height: 0px;">
                        <p>
                        <div>Cả 2 model đều sở hữu 2 cảm biến 12MP, bao gồm 1 cảm biến góc rộng
                            tiêu chuẩn và 1 cảm biến góc siêu rộng. Tuy nhiên, điểm nâng cấp tạo nên sự khác biệt ở
                            camera của iPhone 14 là cảm biến camera chính có khẩu độ f/1.5 tăng khả năng chụp thiếu sáng
                            thêm 49% so với iPhone 1, do đó đem lại khả năng chụp thiếu sáng tốt hơn. Ngoài ra, camera
                            góc rộng cũng được tối ưu để phơi sáng nhanh và bắt nét hiệu quả hơn.</div>
                        </p>
                    </div>
                </div>
                <div class="accordion-item">
                    <div class="accordion-label button__show-faq">
                        <h3>iPhone 14 có mấy màu? Màu đặc trưng của iPhone 14 2023 là màu nào?</h3>
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="10"
                                height="10">
                                <path
                                    d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z">
                    ...
                    <div class="accordion-content" style="max-height: 0px;">
                        <p>
                        <div>iPhone 14 bao gồm 5 màu sắc trẻ trung và năng động phù hợp với nhiều
                            lứa tuổi và đối tượng, cụ thể là Blue (xanh), Purple (tím), Midnight (đen), Starlight
                            (trắng), Product (đỏ). Trong đó, hai màu hoàn toàn mới so với iPhone 13 là màu xanh và
                            tím.&nbsp;</div>
                        </p>
                    </div>
                </div>
        ...
        <div class="compare-apple-devices"><a href="/so-sanh-iphone" class="compare-apple-devices-btn" target="_blank"
                rel="nofollow">
