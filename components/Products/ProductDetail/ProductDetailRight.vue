<template>
  <div class="box-detail-product__box-center column">
            ...
            <div class="icon-thu-cu">
              ...
              >
                <rect
                  ...
                  height="48"
                  rx="8"
                  fill="url(#paint0_linear_97_9297)"
                ></rect>
                <g clip-path="url(#clip0_97_9297)">
                  <path
                    ...
                    fill="url(#paint1_linear_97_9297)"
                  ></path>
                  <path
                    ...
                    fill="url(#paint2_linear_97_9297)"
                  ></path>
                  <path
                    ...
                    fill="url(#paint3_linear_97_9297)"
                  ></path>
                </g>
                <defs>
                  <linearGradient
                    id="paint0_linear_97_9297"
                    x1="26.9247"
                    y1="-99.25"
                    x2="-75.9002"
                    y2="-15.9732"
    ...
    <div class="box-product-promotion">
      <div
        class="box-product-promotion-header is-flex has-text-weight-semibold is-align-items-center"
      >
        <svg
          width="24"
          height="25"
      ...
      <div class="box-product-promotion-content show-all">
        <div class="list-promotion-pack">
          <div class="promotion-pack_item is-flex is-align-content-center">
            ...
            <p
              class="box-product-promotion-detail has-text-black button__promotion"
            >
    ...
    <div class="box-more-promotion my-3">
      <div
        class="box-more-promotion-title has-text-black has-text-weight-semibold"
      >
        <svg
          width="24"
          height="25"
        ...
        >
          <path
            d="M2 15.5H11V24.5H7C5.67392 24.5 4.40215 23.9732 3.46447 23.0355C2.52678 22.0979 2 20.8261 2 19.5V15.5ZM24 11.5C24 12.0304 23.7893 12.5391 23.4142 12.9142C23.0391 13.2893 22.5304 13.5 22 13.5H13V9.457C12.664 9.483 12.329 9.5 12 9.5C11.671 9.5 11.336 9.483 11 9.457V13.5H2C1.46957 13.5 0.960859 13.2893 0.585786 12.9142C0.210714 12.5391 0 12.0304 0 11.5C0 10.4391 0.421427 9.42172 1.17157 8.67157C1.92172 7.92143 2.93913 7.5 4 7.5H5.738C5.1726 7.0016 4.7238 6.38488 4.42344 5.6936C4.12307 5.00232 3.97851 4.25341 4 3.5C4 3.23478 4.10536 2.98043 4.29289 2.79289C4.48043 2.60536 4.73478 2.5 5 2.5C5.26522 2.5 5.51957 2.60536 5.70711 2.79289C5.89464 2.98043 6 3.23478 6 3.5C6 6.122 8.371 7.03 10.174 7.341C9.50852 6.16105 9.10791 4.85037 9 3.5C9 2.70435 9.31607 1.94129 9.87868 1.37868C10.4413 0.81607 11.2044 0.5 12 0.5C12.7956 0.5 13.5587 0.81607 14.1213 1.37868C14.6839 1.94129 15 2.70435 15 3.5C14.8921 4.85037 14.4915 6.16105 13.826 7.341C15.629 7.03 18 6.122 18 3.5C18 3.23478 18.1054 2.98043 18.2929 2.79289C18.4804 2.60536 18.7348 2.5 19 2.5C19.2652 2.5 19.5196 2.60536 19.7071 2.79289C19.8946 2.98043 20 3.23478 20 3.5C20.0215 4.25341 19.8769 5.00232 19.5766 5.6936C19.2762 6.38488 18.8274 7.0016 18.262 7.5H20C21.0609 7.5 22.0783 7.92143 22.8284 8.67157C23.5786 9.42172 24 10.4391 24 11.5ZM11 3.5C11.1207 4.56283 11.4613 5.58891 12 6.513C12.5387 5.58891 12.8793 4.56283 13 3.5C13 3.23478 12.8946 2.98043 12.7071 2.79289C12.5196 2.60536 12.2652 2.5 12 2.5C11.7348 2.5 11.4804 2.60536 11.2929 2.79289C11.1054 2.98043 11 3.23478 11 3.5ZM13 24.5H17C17.6566 24.5 18.3068 24.3707 18.9134 24.1194C19.52 23.8681 20.0712 23.4998 20.5355 23.0355C20.9998 22.5712 21.3681 22.02 21.6194 21.4134C21.8707 20.8068 22 20.1566 22 19.5V15.5H13V24.5Z"
            fill="url(#paint0_linear_bmp)"
          ></path>
          <defs>
            <linearGradient
              id="paint0_linear_bmp"
              x1="18"
              y1="-13.5"
              x2="-5.9444"
              y2="3.07082"
        ...
        >
          ...
          >
            <div class="box-more-promotion-item">
              <div class="box-more-promotion-item__head">
                <img
                  src="https://cdn2.cellphones.com.vn/x/media/wysiwyg/image_1815.png"
                  alt=""
                  loading="lazy"
                  class="icon"
                />
              ...
              <div class="box-more-promotion-item__content">
                ...
                <div class="box-more-promotion-item__info">
                  <p
                    class="box-more-promotion-item__date box-more-promotion-item__date--ongoing"
                  >
                    Đang diễn ra
                  </p>
                  <a
                    href="https://cellphones.com.vn/uu-dai-doi-tac/techcombank"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="box-more-promotion-item__link"
                    ><span>Chi tiết</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="12"
          ...
          >
            <div class="box-more-promotion-item">
              <div class="box-more-promotion-item__head">
                <img
                  src="https://cdn2.cellphones.com.vn/x/media/wysiwyg/image_1814.png"
                  alt=""
                  loading="lazy"
                  class="icon"
                />
              ...
              <div class="box-more-promotion-item__content">
                ...
                <div class="box-more-promotion-item__info">
                  ...
                  <a
                    href="https://cellphones.com.vn/uu-dai-doi-tac/ocb"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="box-more-promotion-item__link"
                    ><span>Chi tiết</span>
            ...
            <div class="box-more-promotion-item">
              ...
              <div class="box-more-promotion-item__content">
                ...
                <div class="box-more-promotion-item__info">
                  ...
                  <a
                    href="https://cellphones.com.vn/uu-dai-doi-tac/mo-the-tin-dung-hsbc"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="box-more-promotion-item__link"
                    ><span>Chi tiết</span>
            ...
            <div class="box-more-promotion-item">
              ...
              <div class="box-more-promotion-item__content">
                ...
                <div class="box-more-promotion-item__info">
                  ...
                  <a
                    href="https://cellphones.com.vn/uu-dai-mo-the-vib-cash-back"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="box-more-promotion-item__link"
                    ><span>Chi tiết</span>
            ...
            <div class="box-more-promotion-item">
              ...
              <div class="box-more-promotion-item__content">
                ...
                <div class="box-more-promotion-item__info">
                  ...
                  <a
                    href="https://cellphones.com.vn/uu-dai-doi-tac/tpbank-evo"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="box-more-promotion-item__link"
                    ><span>Chi tiết</span>
          ...
          >
            ...
            >
              <div class="box-on-stock-item">
                <p
                  title="55B Trần Quang Khải, P. Tân Định, Q. 1, TP. HCM"
                  class="address"
                >
                  55B Trần Quang Khải, P. Tân Định, Q. 1, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871083355" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    href="https://g.page/cps55bhcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            >
              <div class="box-on-stock-item">
                <p
                  title="134 Nguyễn Thái Học, P. Phạm Ngũ Lão, Q.1, TP HCM"
                  class="address"
                >
                  134 Nguyễn Thái Học, P. Phạm Ngũ Lão, Q.1, TP HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000132" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CcUv-Bg4yfcvEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="218-220 Trần Quang Khải, P. Tân Định, Q.1, TP. HCM"
                  class="address"
                >
                  218-220 Trần Quang Khải, P. Tân Định, Q.1, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000218" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://goo.gl/maps/tEsBob3iz5z7HNo68"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871066159" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CfMj9yennN2bEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="139 Trần Não, P. Bình An, Q.2, TP. HCM"
                  class="address"
                >
                  139 Trần Não, P. Bình An, Q.2, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000139" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps139hcm?gm"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="190 Nguyễn Thị Định, khu phố 2, P. An Phú, Q.2, TP. HCM"
                  class="address"
                >
                  190 Nguyễn Thị Định, khu phố 2, P. An Phú, Q.2, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871010190" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/Cazj4BdrnSs7EBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871067171" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  >
                  <a
                    title="177 Khánh Hội, P. 3, Q. 4, TP. HCM"
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/Cc6DULzgXhO5EAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871011785" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  >
                  <a
                    title="785 Trần Hưng Đạo, P.1, Q.5, TP. HCM"
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CbY9KG3a0gcYEBM"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="1075B Hậu Giang, P. 11, Q. 6, TP. HCM"
                  class="address"
                >
                  1075B Hậu Giang, P. 11, Q. 6, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871088075" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://goo.gl/maps/Ucwy7b5Mbq6bQems5"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="458 - 460 Hậu Giang, P.12, Q.6, TP. HCM"
                  class="address"
                >
                  458 - 460 Hậu Giang, P.12, Q.6, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000460" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CQaVjh9biTQWEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="248 Nguyễn Thị Thập, P. Tân Quy, Q.7, TP. HCM"
                  class="address"
                >
                  248 Nguyễn Thị Thập, P. Tân Quy, Q.7, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871088248" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://goo.gl/maps/LwBg8yAs5GMSqDch8"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="571 Huỳnh Tấn Phát, P. Tân Thuận Đông, Q.7, TP. HCM"
                  class="address"
                >
                  571 Huỳnh Tấn Phát, P. Tân Thuận Đông, Q.7, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000571" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CYu9GMcLPoXQEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="435 Nguyễn Thị Thập, P. Tân Phong, Q.7, TP. HCM"
                  class="address"
                >
                  435 Nguyễn Thị Thập, P. Tân Phong, Q.7, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000435" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CZ4NDz2QayicEBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871001579" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  >
                  <a
                    title="579 Dương Bá Trạc, P.1, Q.8, TP. HCM"
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CbJMdjKPy8tgEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="125 Lê Văn Việt, P. Hiệp Phú, Q. 9, TP. HCM"
                  class="address"
                >
                  125 Lê Văn Việt, P. Hiệp Phú, Q. 9, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871061125" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps125hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="241 Lê Văn Việt, P. Hiệp Phú, Q.9, TP. HCM"
                  class="address"
                >
                  241 Lê Văn Việt, P. Hiệp Phú, Q.9, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000241" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CZ9eYH0AgnQvEBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="241-243, Đỗ Xuân Hợp, P. Phước Long B, Q.9, TP. HCM"
                  class="address"
                >
                  241-243, Đỗ Xuân Hợp, P. Phước Long B, Q.9, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871088241" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://goo.gl/maps/wTW57Gp2KFsQBFhr7"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="347 Nguyễn Tri Phương, Phường 5, Quận 10, TP. HCM"
                  class="address"
                >
                  347 Nguyễn Tri Phương, Phường 5, Quận 10, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000347" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871066288" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  >
                  <a
                    title="288 Đường 3/2, P. 12, Q. 10, TP. HCM"
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps288hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="457B Lê Đại Hành, P.11, Q.11, TP. HCM"
                  class="address"
                >
                  457B Lê Đại Hành, P.11, Q.11, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000457" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps457bhcm?gm"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="17 Phan Văn Hớn, P. Tân Thới Nhất, Q.12, TP. HCM"
                  class="address"
                >
                  17 Phan Văn Hớn, P. Tân Thới Nhất, Q.12, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871012017" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CScC9T3PfzGsEBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="93/8C Nguyễn Ảnh Thủ, P. Trung Mỹ Tây, Q.12, TP. HCM"
                  class="address"
                >
                  93/8C Nguyễn Ảnh Thủ, P. Trung Mỹ Tây, Q.12, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000093" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871088001" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CaYKCN2S9qI4EAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="632A Kha Vạn Cân, P. Linh Đông, TP. Thủ Đức, TP. HCM"
                  class="address"
                >
                  632A Kha Vạn Cân, P. Linh Đông, TP. Thủ Đức, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000632" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CdBHCjsKoZihEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="943 Kha Vạn Cân, P. Linh Trung, Thủ Đức, TP. HCM"
                  class="address"
                >
                  943 Kha Vạn Cân, P. Linh Trung, Thủ Đức, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000943" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CZag32KsdAoxEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="18 Võ Văn Ngân, P. Trường Thọ, Q. Thủ Đức, TP. HCM"
                  class="address"
                >
                  18 Võ Văn Ngân, P. Trường Thọ, Q. Thủ Đức, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871097939" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://goo.gl/maps/ZjV4M4C8LHP2pasU9"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="4/39 Quang Trung, Thới Tam Thôn, H. Hóc Môn, TP. HCM"
                  class="address"
                >
                  4/39 Quang Trung, Thới Tam Thôn, H. Hóc Môn, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871088439" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps439ahcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="C3/1A Phạm Hùng, X. Bình Hưng, H. Bình Chánh, TP. HCM"
                  class="address"
                >
                  C3/1A Phạm Hùng, X. Bình Hưng, H. Bình Chánh, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000312" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CShKqciVe2r8EBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871061716" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CRwQAIw6UNfFEAI"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871000193" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CSTIUrxwmeh4EBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871200058" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CUWbraDQmGrlEAI"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="359 Cộng Hòa, P.13, Q. Tân Bình, TP. HCM"
                  class="address"
                >
                  359 Cộng Hòa, P.13, Q. Tân Bình, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871015359" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps359hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="190B Hoàng Văn Thụ, P4, Q. Tân Bình, TP. HCM"
                  class="address"
                >
                  190B Hoàng Văn Thụ, P4, Q. Tân Bình, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000190" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CSw3xpegdNvnEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="672-674 Âu Cơ, P. 14, Q. Tân Bình, TP. HCM"
                  class="address"
                >
                  672-674 Âu Cơ, P. 14, Q. Tân Bình, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871088672" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps672hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="956 Âu Cơ, P.14, Q. Tân Bình, TP. HCM"
                  class="address"
                >
                  956 Âu Cơ, P.14, Q. Tân Bình, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000956" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps956hcm?gm"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="377-379 Điện Biên Phủ, P. 25, Q. Bình Thạnh, TP. HCM"
                  class="address"
                >
                  377-379 Điện Biên Phủ, P. 25, Q. Bình Thạnh, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871077377" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps377hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="536 Xô Viết Nghệ Tĩnh, P. 25, Q. Bình Thạnh, TP. HCM"
                  class="address"
                >
                  536 Xô Viết Nghệ Tĩnh, P. 25, Q. Bình Thạnh, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871065536" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps536hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="59 Quang Trung, P. 10, Q. Gò Vấp, TP. HCM"
                  class="address"
                >
                  59 Quang Trung, P. 10, Q. Gò Vấp, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871088059" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps59hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="272 Nguyễn Oanh, P.17, Q. Gò Vấp, TP. HCM"
                  class="address"
                >
                  272 Nguyễn Oanh, P.17, Q. Gò Vấp, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000272" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CdDvY-OoSsE2EBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="567 Lê Quang Định, P.1, Q. Gò Vấp, TP. HCM"
                  class="address"
                >
                  567 Lê Quang Định, P.1, Q. Gò Vấp, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000567" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CeKNFfsg2bdREBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="525 Quang Trung, P.10, Q. Gò Vấp, TP. HCM"
                  class="address"
                >
                  525 Quang Trung, P.10, Q. Gò Vấp, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871000525" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps525ahcm?gm"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="888 Tỉnh Lộ 10, P. Bình Trị Đông A, Q. Bình Tân, TP. HCM"
                  class="address"
                >
                  888 Tỉnh Lộ 10, P. Bình Trị Đông A, Q. Bình Tân, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871068880" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CXd0aw__78GLEBA"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871000229" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871087386" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="161 Nguyễn Sơn, P. Phú Thạnh, Q. Tân Phú, TP. HCM"
                  class="address"
                >
                  161 Nguyễn Sơn, P. Phú Thạnh, Q. Tân Phú, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871016161" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps161hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871000449" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/r/CcJ6J_Hle1tzEAE"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                ...
                <div class="is-flex">
                  <a href="tel:02871000472" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps472hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
            ...
            <div class="swiper-slide" style="margin-right: 10px">
              <div class="box-on-stock-item">
                <p
                  title="114 Phan Đăng Lưu, P. 3, Q. Phú Nhuận, TP. HCM"
                  class="address"
                >
                  114 Phan Đăng Lưu, P. 3, Q. Phú Nhuận, TP. HCM
                </p>
                <div class="is-flex">
                  <a href="tel:02871097020" class="phone disabled"
                    ><svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener nofollow"
                    href="https://g.page/cps114hcm?share"
                    class="map"
                    ><svg
                      width="16"
                      height="16"
    ...
    <div>
      <div user="[object Object]" data-fetch-key="BoxOrderButton:0">
        <div class="box-order-button-container">
          <div
            class="mb-3 is-flex is-justify-content-space-between"
            style="gap: 6px"
          >
            <div class="installment-wrapper">
              <div style="height: 100%">
                <button
                  id="installmentCta"
                  class="btn-cta installment-group-cta"
                >
...
.block-special-promotion-banner
  .banner-slide
  .button__special-promotion-banner {
  display: block;
  width: 100%;
}
