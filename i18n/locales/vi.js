export default {
  ...
  admin: {
    ...
    orders: {
      ...
      markReady: {
        title: "Sẵn sàng giao",
        subtitle: "Đánh dấu kho đã đóng gói xong và mở shipment để gán shipper.",
        checkPacked: "Đã đóng gói và dán nhãn vận đơn",
        checkLabel: "Đã in tem giao hàng / hóa đơn",
        checkPickup: "Đã lên lịch lấy hàng tại kho",
        partnerLabel: "Đơn vị vận chuyển",
        trackingLabel: "Mã vận đơn (tùy chọn)",
        trackingPlaceholder: "VD: GHTK1234567",
        etaLabel: "Dự kiến giao",
        noteLabel: "Ghi chú",
        notePlaceholder: "Ghi chú cho shipper, tối đa 500 ký tự",
        submit: "Tạo shipment & sẵn sàng giao",
        success: "Đơn đã chuyển sang sẵn sàng giao",
        failed: "Không thể tạo shipment: {msg}",
      },
      assign: {
