<template>
  ...
  >
    ...
    <div class="text-center position-relative p-4" style="z-index: 2;">
      <h1 class="display-1 fw-bold text-dark mb-2">Oops</h1>
      <p class="fs-4 text-secondary mb-2">Trang bạn tìm kiếm không tồn tại</p>
      <p class="text-muted fst-italic mb-4">Kéo chuột để tạo băng rôn và thả ra để xem hiệu ứng pháo hoa!</p>
      <NuxtLink to="/" class="btn btn-dark btn-lg rounded-pill px-5 py-3 d-inline-flex align-items-center gap-2">
