        ...
        <div class="contact-page__info-card">
          ...
          <div class="contact-page__contact-list">
            ...
            <div class="contact-page__contact-item">
              ...
              <div>
                <strong>Email</strong>
                <span>support@irusgear.com</span>
              </div>
            </div>
            <div class="contact-page__contact-item">
...
.contact-page__contact-item > div {
  display: flex;
  flex-direction: column;
  gap: 2px;
}
