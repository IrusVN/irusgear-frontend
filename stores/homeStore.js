...
export const useHomeStore = defineStore("home", () => {
  ...
  const CATEGORY_CONFIGS = {
    phone: {
      ...
      gifts: ["IrusGear Member giảm đến 500.000đ", "S-Student giảm thêm 300.000đ"],
      needIconMap: {
    ...
    tablet: {
      ...
      gifts: ["IrusGear Member giảm đến 230.000đ", "S-Student giảm thêm 500.000đ", "Không phí chuyển đổi khi trả góp 0% qua thẻ tín dụng kỳ hạn 3-6 tháng"],
    },
    laptop: {
      slug: "laptop",
      defaultTitle: "LAPTOP",
      ...
      gifts: ["IrusGear Member giảm đến 500.000đ", "S-Student giảm thêm 300.000đ", "Trả góp 0% lãi suất qua thẻ tín dụng"],
    },
    monitor: {
      ...
      gifts: ["IrusGear Member giảm đến 300.000đ", "S-Student giảm thêm 200.000đ", "Trả góp 0% lãi suất qua thẻ tín dụng"],
    },
    pc: {
      slug: "pc",
      defaultTitle: "PC",
      ...
      gifts: ["IrusGear Member giảm đến 400.000đ", "S-Student giảm thêm 300.000đ", "Ưu đãi lắp đặt và giao hàng nhanh"],
    },
    computerAccessory: {
      ...
      gifts: ["IrusGear Member giảm đến 200.000đ", "S-Student giảm thêm 150.000đ", "Giao hàng nhanh toàn quốc"],
    },
    watch: {
      slug: "dong-ho",
      ...
      gifts: ["IrusGear Member giảm đến 300.000đ", "S-Student giảm thêm 200.000đ", "Bảo hành chính hãng toàn quốc"],
    },
    audio: {
      slug: "am-thanh",
    ...
    tv: {
      ...
      gifts: ["IrusGear Member giảm đến 600.000đ", "S-Student giảm thêm 300.000đ", "Giao hàng lắp đặt nhanh toàn quốc"],
    },
    homeAppliance: {
      slug: "do-gia-dung",
      ...
      gifts: ["IrusGear Member giảm đến 300.000đ", "S-Student giảm thêm 200.000đ", "Giao nhanh toàn quốc"],
    },
    beautyHealth: {
      ...
      gifts: ["IrusGear Member giảm đến 250.000đ", "S-Student giảm thêm 150.000đ", "Sản phẩm chính hãng"],
    },
    fridgeFreezer: {
      ...
      discounts: [9, 7, 8, 10, 6, 11],
      gifts: ["IrusGear Member giảm đến 500.000đ", "S-Student giảm thêm 300.000đ", "Hỗ trợ giao lắp nhanh"],
    },
    washingMachine: {
      slug: "may-giat",
      ...
      gifts: ["IrusGear Member giảm đến 500.000đ", "S-Student giảm thêm 300.000đ", "Giao lắp nhanh toàn quốc"],
    },
    dryer: {
      ...
      gifts: ["IrusGear Member giảm đến 400.000đ", "S-Student giảm thêm 250.000đ", "Hỗ trợ giao lắp nhanh"],
    },
    airConditioner: {
      ...
      gifts: ["IrusGear Member giảm đến 600.000đ", "S-Student giảm thêm 300.000đ", "Lắp đặt nhanh toàn quốc"],
    },
  };
